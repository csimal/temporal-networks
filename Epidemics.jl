...
"""
function epidemic_step_sir(g::AbstractSimpleGraph, α::Real, β::Real, state::Vector{EpidemicState}, t=0.0, Δt=1.0)
...
"""
function average_sir(g, α::Real, β::Real, state::Vector{EpidemicState}, max::Integer)
    n = length(state)
